...
//SOURCES SimpleEnsembleELM.java
...
public class trainEnsambleELM_Mnist {

    public static void main(String[] args) {
        final long startTime = System.currentTimeMillis();

        // Example: Assuming the data has 784 inputs, 10 hidden neurons, and 1 output
        //final SimpleEnsembleELM.EnsembleELM myELM = new SimpleEnsembleELM.EnsembleELM(30, 784, 1000, 10);
        final SimpleEnsembleELM.EnsembleELM myELM
                = new SimpleEnsembleELM.EnsembleELM(Arrays.asList(
                        new SimpleEnsembleELM.SimpleELM(784, 100, 10),
                        new SimpleEnsembleELM.SimpleELM(784, 100, 10),
                        new SimpleEnsembleELM.SimpleELM(784, 100, 10),
                        new SimpleEnsembleELM.SimpleELM(784, 100, 10),
                        new SimpleEnsembleELM.SimpleELM(784, 100, 10)
        ...
        trainData.trainChunk(400, true, (inputVals, targetVals) -> {
            ...
            myELM.trainAllModels(inputBatch, targetBatch);
        });
        ...
        trainData.testPredictChunk(12_000, (inputVals, targetVals) -> {
            ...
            final int predictedLabel = myELM.predictForClassification(inputVals);//TrainingData.getMaxIndex(predictions);
