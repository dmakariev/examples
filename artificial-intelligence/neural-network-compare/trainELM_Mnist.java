...
public class trainELM_Mnist {
    ...
    public static void main(String[] args) {
        ...
        trainData.trainChunk(40, true, (inputVals, targetVals) -> {
        ...
        myELM.saveModel(inputWeights -> outputWeights -> biases -> {
            TrainingData.saveTo("model/elm_mnist-100.csv", inputWeights, outputWeights, biases);
        });
